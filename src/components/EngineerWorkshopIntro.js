  ...
  return (
    ...
    <div  className='Top'>
      ...
      <div className="Header"  >
        <center>
          <p style = {one}> E 6.1</p>
          <p style = {mystyle}> Engine Rooms: Engineer Workshop</p>
        ...
        <AccordionDetails>
          ...
          Leave the main engine rooms and follow the wall markings to the next room. 
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion style = {{ width: "90%"}}>
        ...
        <AccordionDetails>
          <Typography style= {{fontFamily: "EuphemiaUCAS",color: "#2c368b"}}>
          Take some time to appreciate the artifacts to your right and the stories on the left. 
          Be sure to watch the video to learn more about what it was like to work in Tower Bridge. 

When you have finished this, turn to the left and press Continue.
...
export default EngineerWorkshopIntro;